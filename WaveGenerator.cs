				...
				foreach(Wave W in waves)
				{
					...
					if (A.message != "")
						...
						if (A.prefab != null && A.spawnCount > 0)
						{
							...
							Vector3 spawnPosition = new Vector3 (spawnbar.transform.position.x, Random.Range(-6f, 6f), spawnbar.transform.position.z);
							Quaternion spawnRotation = spawnbar.transform.localRotation;
